namespace FinalProject.JobManager
{
    partial class exceptionsList
    {
        ...
        private void InitializeComponent()
        {
			...
			this.monthlyExecptionsHours.Text = "תפריט";
			...
			this.dataGridEvents.RowHeadersWidth = 62;
			...
			this.LicenseNumber1.Width = 94;
			// 
			// BrandModel1
			// 
			this.BrandModel1.HeaderText = "יצרן/דגם";
			this.BrandModel1.MinimumWidth = 8;
			...
			this.CostumerName1.MinimumWidth = 8;
			this.CostumerName1.Name = "CostumerName1";
			this.CostumerName1.ReadOnly = true;
			this.CostumerName1.Resizable = System.Windows.Forms.DataGridViewTriState.False;
			this.CostumerName1.Width = 205;
			// 
			// CurrentActivity
			// 
			this.CurrentActivity.HeaderText = "פעילות נוכחית";
			this.CurrentActivity.MinimumWidth = 8;
			...
			this.DaysOfState.MinimumWidth = 8;
			...
			this.ComponentStatusReady.MinimumWidth = 8;
			...
			this.textComponentStatusReady.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.textComponentStatusReady.TabIndex = 68;
			...
			this.textComponentStatusToOrder.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.textComponentStatusToOrder.TabIndex = 69;
			...
			this.textLicenseNumber.TabIndex = 67;
			...
			this.textBrandAndModel.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.textBrandAndModel.Name = "textBrandAndModel";
			this.textBrandAndModel.Size = new System.Drawing.Size(96, 20);
			this.textBrandAndModel.TabIndex = 66;
			...
			this.textDaysOfState.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.textDaysOfState.Name = "textDaysOfState";
			this.textDaysOfState.Size = new System.Drawing.Size(69, 20);
			this.textDaysOfState.TabIndex = 63;
			this.textDaysOfState.TextChanged += new System.EventHandler(this.textDaysOfState_TextChanged);
			// 
			// textGaragePhoneNumber
			// 
			this.textGaragePhoneNumber.Location = new System.Drawing.Point(190, 44);
			this.textGaragePhoneNumber.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.textGaragePhoneNumber.Name = "textGaragePhoneNumber";
			this.textGaragePhoneNumber.Size = new System.Drawing.Size(67, 20);
			this.textGaragePhoneNumber.TabIndex = 62;
			this.textGaragePhoneNumber.TextChanged += new System.EventHandler(this.textGaragePhoneNumber_TextChanged);
			// 
			// textEventNumber
			// 
			...
			this.textEventNumber.TabIndex = 61;
